...
| --- | --- | --- | --- |
| InitCloud | AWS,NCP Terraform 보안 솔루션 | 정적분석도구개발 | [Repo](https://github.com/)  |
| 5ratherProj | AI알고리즘을 활용한 CCTV 상권분석 서비스 | BE | [Repo](https://github.com/) | 
| JJACK | 봉사활동 적립 앱 | SERVER | [Repo](https://github.com/) | 
